...
if CONFIG_STATICSOFTWARETIMERBLINKER_ENABLE == "y" then
	...
	local filename = OUTPUT .. tup.getrelativedir(TOP) .. "/staticSoftwareTimerBlinker"
...
end	-- if CONFIG_STATICSOFTWARETIMERBLINKER_ENABLE == "y" then
