...
if CONFIG_STATICTHREADBLINKER_ENABLE == "y" then
	...
	local filename = OUTPUT .. tup.getrelativedir(TOP) .. "/staticThreadBlinker"
...
end	-- if CONFIG_STATICTHREADBLINKER_ENABLE == "y" then
